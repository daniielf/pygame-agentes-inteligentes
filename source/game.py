...
def main(screen, car_type, level, track, retry = 1, userID = '001'):
    ...
    class Game:
        ...
        def adjustLevel(self):
            if (not self.setToEasy):
                ...
                if self.track == 2:
                    ...
                    self.chronometer.start(self.time)
                    self.timeStrikeValue = CONFIG._L2_penalidade_tempo_facil
        ...
        def track_01(self):
            ...
            self.agente_escrita.escreveLog(['NOVOJOGO', '-'])
        ...
        def track_02(self):
            ...
            self.agente_escrita.escreveLog(['NOVOJOGO', '-'])  # ESCREVE 'NOVOJOGO' PARA O JOGADOR
        ...
        def shift_track(self):
            ...
            if self.track == 3:
                return False
            self.agente_escrita.escreveLog(['PASSOUFASE', str(self.track)])
            ...
            if status == 'lose':
                ...
                if 218 <= mouse_pos[0] <= 392 and 352 <= mouse_pos[1] <= 368:
                    ...
                    if pygame.mouse.get_pressed()[0]:
                        ...
                        main(screen, car_type, level, self.track, tentatives + 1, _userid)
